    ...
    <>
      ...
      <style jsx global>{`
        ...
        .loader {
          ...
          background: radial-gradient(1.13em at 50% 1.6em, white 99%, #0000 101%) calc(50% - 1.6em) 0 / 3.2em 100% text,
            radial-gradient(1.13em at 50% -0.8em, #0000 99%, white 101%) 50% 0.8em / 3.2em 100% repeat-x text;
        ...
        .full-name {
          margin-top: 2.4rem; /* space below AS */
          margin-bottom: 0.25rem;
          font-family: "Nexa", sans-serif;
          font-weight: 900;
          font-size: 3.25rem; /* large heading */
          color: #bdbdbd; /* medium grey like screenshot */
          text-transform: none;
        ...
        .subtitle {
          ...
          font-weight: 700;
          font-size: 0.875rem;
          color: rgba(255,255,255,0.18); /* faint grey */
          text-transform: uppercase;
        ...
        @media (max-width: 640px) {
          .loader { font-size: 3.6rem }
          .full-name { font-size: 2rem; margin-top: 1.6rem }
